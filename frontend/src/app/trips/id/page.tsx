    ...
    if (!trip) {
        return (
            <div className="py-20 text-center">
                <p className="text-foreground">No encontramos este viaje.</p>
                <Button
        ...
        <section className="flex flex-col gap-8">
            ...
            >
                <EmptyState
                    ...
                    description="Registra los gastos compartidos para llevar las cuentas claras."
                />
            </TripSection>
            ...
            >
                <EmptyState
                    ...
                    description="Crea una lista de pendientes para no olvidar nada antes de viajar."
                />
            </TripSection>
        </section>
    )
